...
int main (int argc, char *argv[])
{
    ...
    MPI_Comm_split(MPI_COMM_WORLD, old_rank / 4, old_rank % 4, &custom_group);
    ...
    MPI_Recv(&recv_rank, 1, MPI_INT, new_rank == 0 ? new_size - 1 : new_rank - 1, MPI_ANY_TAG, custom_group, MPI_STATUS_IGNORE);
